...
namespace AVLTreeNode
{
    public class AVLTree<T> : IEnumerable<T> where T : IComparable
    {
        ...
        {
            // Вариант 1: Добавление нового узла в дерево. Значение добавляемого узла меньше чем значение текущего узла.      
            ...
            // Вариант 2: Добавляемое значение больше или равно текущему значению.
